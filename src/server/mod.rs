...
pub fn build_router(state: SharedState) -> Router {
    Router::new()
        ...
        .route("/api/documents/:id/versions", post(api::create_version))
        ...
        .route("/api/import", post(api::import_file))
        ...
        .route("/api/ai/config", get(api::get_ai_config))
        .route("/api/ai/config", put(api::set_ai_config))
