...
pub struct LayoutEngine {
    pub page_layout: crate::core::PageLayout,
    pub dpi: f32,
}

impl LayoutEngine {
    pub fn new(page_layout: crate::core::PageLayout) -> Self {
    ...
    pub fn layout_document(&self, doc: &crate::core::Document) -> Vec<LayoutPage> {
    ...
    fn layout_block(
        &self,
        block: &crate::core::document::Block,
        x: f32,
        _y: f32,
        width: f32,
        cursor_y: &mut f32,
    ...
    fn layout_paragraph(
        &self,
        para: &crate::core::document::Paragraph,
        x: f32,
        cursor_y: &mut f32,
        width: f32,
    ) -> Vec<LayoutBox> {
    ...
    fn layout_heading(
        &self,
        heading: &crate::core::document::Heading,
        x: f32,
        cursor_y: &mut f32,
        width: f32,
    ) -> Vec<LayoutBox> {
