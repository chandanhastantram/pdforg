        ...
        for para in &tb.paragraphs {
            ...
            if !text_content.is_empty() {
                ...
                content.push_str(&format!(
                    ...
                    font_style,
                    match para.align {
                        crate::core::TextAlign::Left => "start",
                        crate::core::TextAlign::Center => "middle",
                        crate::core::TextAlign::Right => "end",
                        crate::core::TextAlign::Justify => "start",
                    },
                    text_content
                ));
